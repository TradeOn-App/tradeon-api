...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE internal_transactions ADD CONSTRAINT internal_transactions_type_check CHECK (type IN ('deposit', 'withdrawal', 'commission_withdrawal', 'client_withdrawal', 'initial_value', 'updated_value'))");
    }
