...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .client-info {
            background: #f8f8f6; border: 1px solid #e8e5e0; border-left: 3px solid #00807f;
            padding: 16px 20px; margin-bottom: 28px; display: table; width: 100%;
        }
        .client-info-left { display: table-cell; vertical-align: middle; }
        .client-info-right { display: table-cell; vertical-align: middle; text-align: right; }
        .client-name { font-size: 14px; font-weight: 600; color: #1a1a1a; }
        .client-doc { color: #7A7F82; font-size: 10px; margin-top: 2px; }
        .client-profit-label { font-size: 8px; text-transform: uppercase; letter-spacing: 0.8px; color: #7A7F82; font-weight: 600; }
        .client-profit-value { font-size: 2rem; font-weight: 700; line-height: 1.1; }
        ...
        <div class="content">
            <div class="client-info">
                ...
                <div class="client-info-right">
                    ...
                    <div class="client-profit-value {{ $report->profit_value_brl > 0 ? 'color-teal' : 'color-gray' }}">
                        US$ {{ number_format($report->profit_value_brl, 2, ',', '.') }}
                    </div>
                </div>
            </div>
            ...
            <div class="metrics">
                <div class="metric-box">
                    ...
                    <div class="value color-teal">US$ {{ number_format($report->initial_value_brl, 2, ',', '.') }}</div>
                </div>
                <div class="metric-box">
                    <div class="label">Valor Atualizado</div>
                    <div class="value">US$ {{ number_format($report->updated_value_brl, 2, ',', '.') }}</div>
                </div>
                <div class="metric-box">
                    <div class="label">Ganho Real</div>
                    <div class="value {{ $report->real_gain_brl >= 0 ? 'color-teal' : 'color-red' }}">
                        US$ {{ number_format($report->real_gain_brl, 2, ',', '.') }}
                    </div>
                </div>
                <div class="metric-box">
            ...
            <div class="summary-row">
                <div class="summary-box">
                    ...
                    <div class="value color-gold">US$ {{ number_format($report->commission_value_brl, 2, ',', '.') }}</div>
                </div>
                <div class="summary-box">
                    <div class="label">Valor Inicial {{ $nextPeriod }}</div>
                    <div class="value color-teal">US$ {{ number_format($report->next_month_initial_brl, 2, ',', '.') }}</div>
                </div>
            </div>
            ...
            @else
                <table class="transactions">
                    <thead>
                        <tr><th>Tipo</th><th>Valor</th><th>Moeda</th><th>Data</th></tr>
                    </thead>
                    <tbody>
